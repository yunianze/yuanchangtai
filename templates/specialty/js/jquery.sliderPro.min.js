...
! function(a, b) { "use strict";
    ...
    d.prototype = { _init: function() {
            ...
            if (null !== g && this.$slider.addClass("ie ie" + parseInt(g[2], 10)), this.$slidesContainer = b('<div class="sp-slides-container"></div>').appendTo(this.$slider), this.$slidesMask = b('<div class="sp-mask"></div>').appendTo(this.$slidesContainer), this.$slides = this.$slider.find(".sp-slides").appendTo(this.$slidesMask), this.$slider.find(".sp-slide").appendTo(this.$slides), this.settings.shuffle === !0) {
                var h = this.$slides.find(".sp-slide"),
                    i = [];
                h.each(function(a) { d.shuffledIndexes.push(a) }), this.shuffledIndexes = this.shuffledIndexes.sort(function() {
                    return .5 - Math.random() }), b.each(this.shuffledIndexes, function(a, b) { i.push(h[b]) }), this.$slides.empty().append(i) }
            var j = b.SliderPro.modules;
            if ("undefined" != typeof j)
                for (var k in j) {
                    var l = j[k].substring(0, 1).toLowerCase() + j[k].substring(1) + "Defaults"; "undefined" != typeof this[l] && b.extend(this.settings, this[l]) }
            ...
            if ("css-3d" === this.supportedAnimation || "css-2d" === this.supportedAnimation) {
                ...
                a[this.vendorPrefix + "transform"] = "css-3d" === this.supportedAnimation ? "translate3d(" + e + "px, " + f + "px, 0)" : "translate(" + e + "px, " + f + "px)", a[this.vendorPrefix + "transition"] = "", this.$slides.css(a), this.$slides.off(this.transitionEvent), this.slidesPosition = "horizontal" === this.settings.orientation ? e : f } else this.$slides.stop(), this.slidesPosition = parseInt(this.$slides.css("margin-" + this.positionProperty), 10);
    ...
    var f = { supportedAnimation: null, vendorPrefix: null, transitionEvent: null, getSupportedAnimation: function() {
            ...
            return a.is("img") && a[0].complete === !1 ? c = "loading" : a.find("img").each(function() {
                var a = b(this)[0];
                a.complete === !1 && (c = "loading") }), c } };
    a.SliderProUtils = f }(window, jQuery),
function(a, b) {
    "use strict";
    var c = "Thumbnails." + b.SliderPro.namespace,
        d = { $thumbnails: null, $thumbnailsContainer: null, thumbnails: [], selectedThumbnailIndex: 0, thumbnailsSize: 0, thumbnailsContainerSize: 0, thumbnailsPosition: 0, thumbnailsOrientation: null, thumbnailsPositionProperty: null, isThumbnailScroller: !1, initThumbnails: function() {
                var a = this;
                this.on("update." + c, b.proxy(this._thumbnailsOnUpdate, this)), this.on("sliderResize." + c, b.proxy(this._thumbnailsOnResize, this)), this.on("gotoSlide." + c, function(b) { a._gotoThumbnail(b.index) }) }, _thumbnailsOnUpdate: function() {
                var a = this;
                ...
                if (this.isThumbnailScroller = !0, null === this.$thumbnailsContainer && (this.$thumbnailsContainer = b('<div class="sp-thumbnails-container"></div>').insertAfter(this.$slidesContainer), this.$thumbnails = this.$slider.find(".sp-thumbnails").appendTo(this.$thumbnailsContainer), this.settings.shuffle === !0)) {
                    ...
                    b.each(this.shuffledIndexes, function(a, e) {
                        var f = b(c[e]);
                        0 !== f.parent("a").length && (f = f.parent("a")), d.push(f) }), this.$thumbnails.empty().append(d) }
...
function(a, b) { "use strict";
    var c = "ConditionalImages." + b.SliderPro.namespace,
        d = { previousImageSize: null, currentImageSize: null, initConditionalImages: function() { this.currentImageSize = this.previousImageSize = "default", this.on("update." + c, b.proxy(this._conditionalImagesOnUpdate, this)), this.on("sliderResize." + c, b.proxy(this._conditionalImagesOnResize, this)) }, _conditionalImagesOnUpdate: function() { b.each(this.slides, function(a, c) {
                    var d = c.$slide;
                ...
                if (this.currentImageSize = this.slideWidth <= this.settings.smallSize ? "small" : this.slideWidth <= this.settings.mediumSize ? "medium" : this.slideWidth <= this.settings.largeSize ? "large" : "default", this.previousImageSize !== this.currentImageSize) {
                    ...
                    b.each(this.slides, function(c, d) {
                        ...
                        e.find("img").each(function() {
                            var c = b(this),
                                e = c.attr("data-" + a.currentImageSize); "undefined" != typeof e && ("undefined" != typeof c.attr("data-src") ? c.attr("data-src", e) : a._loadConditionalImage(c, e, function(a) { a.hasClass("sp-image") && (d.$mainImage = a, d.resizeMainImage(!0)) })) }) }), this.previousImageSize = this.currentImageSize } }, _loadConditionalImage: function(a, c, d) {
                var e = b(new Image);
