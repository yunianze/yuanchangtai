...
class important extends connector {
	...
	function onlanguagelist() {
		...
		$sql = 'SELECT id,pid,lng,lngtitle,lockin,iswap,isopen,isuptype,sitename,keyword,description,copyright FROM ' . $db_table . $db_where . ' ORDER BY ' . $limitkey . ' ' . $limitclass . ' LIMIT ' . $MinPageid . ',' . $MaxPerPage;
