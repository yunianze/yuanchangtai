					...
					<table border="0" cellpadding="0" style="width: 90%;" class="style1">
						...
						<tr>
							...
							<table style="width: 100%">
								<tr>
									<td class="left_botton" valign="top" style="padding-top:16px;">
										<ul>
									...
									<div id="heddien" style="overflow: hidden;"><iframe id="I1" border="0" frameborder="0" marginheight="0" width="0" height="0" marginwidth="0" name="I1" scrolling="no" src="http://www.ecisp.cn"></iframe>
									<?php } ?>
									...
									<div class="centerblock">
										<table style="width: 100%">
											...
											<tr>
												...
												<td class="td01 left"><input type="text" name="dbname" value="SS_" size="35" class="logininput"/> （请向主机服务商索取数据库名称）</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="td01 left"><input type="text" name="tablepre" value="SS_" size="35" class="logininput"/></td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="2" class="td01 left"><h2>组件管理</h2></td>
											</tr>
											<tr>
												<td class="td01 right" width="20%">请选择安装组件：</td>
												<td class="td01 left">
													<ul class="applist">
													<?php if (count($this->_tpl_vars['app_items'])>0){$divid_ii=1;for($ii=0;$ii<count($this->_tpl_vars['app_items']); $ii++){?>
														<?php if($this->_tpl_vars['app_items'][$ii]['isdel']==1){ ?>
															<li><input name="apptype[]" type="checkbox" value="<?php echo $this->_tpl_vars['app_items'][$ii]['appcode'] ?>" checked/>&nbsp;<?php echo $this->_tpl_vars['app_items'][$ii]['appname'] ?></li>
														<?php }else{ ?>
															<li><input name="apptype[]" type="checkbox" value="<?php echo $this->_tpl_vars['app_items'][$ii]['appcode'] ?>" checked  disabled/>&nbsp;<?php echo $this->_tpl_vars['app_items'][$ii]['appname'] ?></li>
														<?php } ?>
													<?php }} ?>
													</ul>
												</td>
											...
											<tr>
												<td></td>
												<td class="setupdes">更多组件可以在安装成功后，登陆后台点击“设置-网站组件管理”进行自定义安装!</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="td01 left">
													<input type="text" name="sitename" value="" style="width:250px" size="100" class="logininput">
												</td>
											</tr>
											<tr>
									...
									<div class="btnbox marginbot">
										<input type="button" onclick="history.back();" value="上一步" class="inputsubmit01"/>
										<input type="submit" name="submit" value="确认并安装" class="inputsubmit01"/>&nbsp;
									</div>
									</form>
									<?php } ?>
									</td>
