...
INSERT INTO `ssp_admin_powergroup` (`id`, `powername`, `powerlist`, `delclass`) VALUES
(1, '系统管理组', 'all', 1);

INSERT INTO `ssp_album_images` (`amid`, `pid`, `lng`, `title`, `content`, `pic`, `addtime`, `isclass`, `istop`) VALUES
(1, 50, 'cn', '企业图片', '', '', 1404632110, 1, 0),
(2, 50, 'cn', '新闻图片', '', '', 1404632116, 1, 0),
(3, 50, 'cn', '广告图片', '', '', 1404632122, 1, 0),
(4, 50, 'cn', '产品图片', '', '', 1404632127, 1, 0);

INSERT INTO `ssp_apply` (`appid`, `applyname`, `applymenu`, `applycontent`, `applycode`, `applyvol`, `applypic`, `volsn`, `uservol`, `addtime`, `setuptime`, `isdel`, `isetup`, `issystem`, `issqlbak`, `isfree`) VALUES
...
(2, '留言论坛管理', '留言论坛管理', '用于在线留言，可以设置留言访问权限、手机短信提醒、邮箱提醒、留言模板定义等功能', 'bbs', 'V6.0', 'upfile/app/20140710013155_591.jpg', 601, 6000140707, 1404927530, 0, 0, 0, 0, 1, 0),
...
INSERT INTO `ssp_city` (`id`, `parentid`, `cityname`, `regiontype`, `agencyid`) VALUES
(1, 0, '中国', 0, 0),
(2, 1, '北京', 1, 0),
(3, 1, '安徽', 1, 0),
(4, 1, '福建', 1, 0),
...
INSERT INTO `ssp_filename` (`fiid`, `username`, `filetitle`, `filename`, `extension`, `filetype`, `filepath`, `addtime`, `iswidth`, `pathnow`) VALUES
...
(64, 'admin', '', 'logo.jpg', 'jpg', 'img', 'upfile/', 1404660368, 1, 0),
...
(68, 'admin', '', 'weiwz.jpg', 'jpg', 'img', 'upfile/', 1404660687, 1, 0),
(67, 'admin', '', 'kubcmslogo.jpg', 'jpg', 'img', 'upfile/', 1404660444, 1, 0),
(70, 'admin', '', 'applogo.jpg', 'jpg', 'img', 'upfile/', 1404661241, 1, 0),
...
INSERT INTO `ssp_form_attr` (`faid`, `fgid`, `pid`, `typename`, `typeremark`, `attrname`, `inputtype`, `attrvalue`, `validatetext`, `attrsize`, `attrrow`, `attrlenther`, `isclass`, `isvalidate`, `isline`) VALUES
...
INSERT INTO `ssp_form_group` (`fgid`, `pid`, `lng`, `formgroupname`, `formcode`, `pic`, `content`, `successtext`, `template`, `emailatt`, `addtime`, `isclass`, `ismenu`, `iswap`, `isseccode`, `ismail`, `mailcode`, `putmail`, `inputtime`, `purview`, `issms`, `smscode`, `titlestyle`) VALUES
(1, 50, 'cn', '信息反馈', 'feedback', 'upfile/type_pic.jpg', '', '', 'form', 'emailatt', 1404626175, 1, 1, 0, 1, 0, '', '', 0, 0, 0, '', '{typename}-{sitename}');


INSERT INTO `ssp_lng` (`id`, `pid`, `lng`, `lngtitle`, `url`, `lockin`, `iswap`, `isopen`, `isuptype`, `ispack`, `packname`, `sitename`, `keyword`, `description`, `copyright`) VALUES
...
INSERT INTO `ssp_lngpack` (`lpid`, `pid`, `lng`, `title`, `keycode`, `langstr`, `lockin`, `typeid`) VALUES
(1, 50, 'cn', '网站名称', 'sitename', '易思企业网站管理系统V6 - 最专业的企业建站管理平台', 0, 3),
(2, 50, 'cn', '关键字', 'keyword', '易思,,PHP企业网站管理系统,开源企业网站系统,企业网站建设,ecisp.cn,earclink.com', 0, 3),
(3, 50, 'cn', '网站简介', 'description', 'V6是一套基于LAMP开发构建的企业网站管理系统。可以帮您迅速、轻松地构建起一个强大专业的企业网站。内置多模型自定、SEO搜索优化、静态页生成、评论留言、订购、会员等常见企业网站基本功能，通过灵活的插件机制还能扩展应用，帮您更好地实现网站价值', 0, 3),
...
(218, 50, 'en', '关键字', 'keyword', ',cms,,v6,v6,ecisp,earclink', 0, 3),
(219, 50, 'en', '网站名称', 'sitename', 'V6-The most professional enterprise site management platform', 0, 3),
...
(235, 50, 'cn', '功能关闭', 'close_err', '抱歉，当前功能已关闭使用，如有疑问请与网站管理员联系！', 0, 4),
(236, 50, 'en', '功能关闭', 'close_err', 'Sorry, function has been closed, if you have any questions please contact the webmaster! ', 0, 4);

INSERT INTO `ssp_mailinvite_type` (`mlvid`, `lng`, `title`, `content`, `purview`, `isclass`, `addtime`) VALUES
(1, 'cn', '参与企业邮件营销', '', 0, 1, 1404632368),
(2, 'en', '邮件订阅英文用户', '', 0, 1, 1404665839);

INSERT INTO `ssp_member_class` (`mcid`, `rankname`, `isinter`, `integra`, `isclass`, `lockin`) VALUES
(1, '标准会员', 0, 100, 1, 1),
(2, '高级会员', 0, 100, 1, 0);

INSERT INTO `ssp_menulink` (`mlid`, `pid`, `type`, `topmlid`, `menuname`, `linkurl`, `isshow`, `loadfun`, `classname`, `ismenu`, `isclass`) VALUES
...
INSERT INTO `ssp_model` (`mid`, `lng`, `modelname`, `pagemax`, `tsnstyle`, `listtitlestyle`, `readtitlestyle`, `pagesylte`, `isclass`, `lockin`, `isbase`, `istsn`, `isalbum`, `isextid`, `issid`, `isfgid`, `islinkdid`, `isorder`, `ismessage`, `ispurview`, `addtime`, `opid`) VALUES
...
INSERT INTO `ssp_model_att` (`aid`, `pid`, `mid`, `typename`, `typeremark`, `attrname`, `inputtype`, `attrvalue`, `attrsize`, `attrrow`, `attrlenther`, `isvalidate`, `validatetext`, `isclass`, `issearch`, `lockin`, `islockin`, `issys`) VALUES
...
(4, 0, 0, '来源', '', 'source', 'selectinput', '.COM\r\nECISP.CN\r\nEARCLINK.COM\r\nKUBCMS.COM\r\nYUNSYS.COM', 20, 5, 20, 0, '', 1, 0, 1, 0, 0),
...
(13, 50, 1, '来源', '', 'source', 'selectinput', '.COM\nECISP.CN\nEARCLINK.COM\nKUBCMS.COM\nYUNSYS.COM', 20, 5, 250, 0, '', 0, 0, 1, 1, 4),
...
(24, 50, 3, '来源', '', 'source', 'selectinput', '.COM\nECISP.CN\nEARCLINK.COM\nKUBCMS.COM\nYUNSYS.COM', 20, 5, 250, 0, '', 0, 0, 1, 1, 4),
...
(33, 50, 4, '来源', '', 'source', 'selectinput', '.COM\nECISP.CN\nEARCLINK.COM\nKUBCMS.COM\nYUNSYS.COM', 20, 5, 250, 0, '', 0, 0, 1, 1, 4),
...
(46, 50, 5, '来源', '', 'source', 'selectinput', '.COM\nECISP.CN\nEARCLINK.COM\nKUBCMS.COM\nYUNSYS.COM', 20, 5, 250, 0, '', 0, 0, 1, 1, 4),
...
(50, 50, 6, '来源', '', 'source', 'selectinput', '.COM\nECISP.CN\nEARCLINK.COM\nKUBCMS.COM\nYUNSYS.COM', 20, 5, 250, 0, '', 0, 0, 1, 1, 4),
...
INSERT INTO `ssp_order_pay` (`opid`, `pid`, `payname`, `paycontent`, `paycode`, `payis`, `payplugver`, `pluglist`, `isclass`, `addtime`) VALUES
(1, 50, '货到付款', '货到付款支付的城市有北京、上海、广州、深圳、武汉、长春、重庆', 'downpay', 0, '1.0.1', 'a:0:{}', 1, 1404631401);


INSERT INTO `ssp_order_shipping` (`osid`, `pid`, `title`, `content`, `price`, `markup`, `isclass`, `iscash`, `isinsure`, `insureper`, `addtime`) VALUES
(1, 50, '普通快递', '', 0.00, 0, 1, 0, 0, 0, 1404631390);

INSERT INTO `ssp_skin` (`skid`, `name`, `code`, `lockin`, `isclass`, `addtime`, `iswap`) VALUES
(1, 'V6清新主题', 'specialty', 0, 1, 1404632214, 0);



INSERT INTO `ssp_templates` (`tmid`, `lng`, `templatename`, `templatecode`, `title`, `templatecontent`, `pic`, `typeclass`, `styleclass`, `lockin`, `addtime`, `isclass`) VALUES
...
INSERT INTO `ssp_config` (`id`, `pid`, `valname`, `content`, `str`, `value`, `valtype`, `bottonname`, `groupid`, `isline`, `isselect`) VALUES
...
(33, 50, 'img_wmt_text', '水印文字', '如水印类型文字水印,此项必填,且只允许填写英文及数字', '', 'string', '', 4, 0, ''),
...
(190, 50, 'softvol', '', '', '6700160531', 'string', '', 99, 0, ''),
(191, 50, 'softvolstr', '', '', 'V6.7.16.05.31 UTF8', 'strint', '', 99, 0, ''),
(192, 50, 'wap_templates', '手机模板', '', 'touch', 'font', '', 99, 0, ''),
(193, 3, 'wap_telstr', '一键拨打电话', '请输入电话号码，用于WAP版本手机一键拨打功能', '18665655030', 'font', '', 7, 0, ''),
...
(198, 50, 'wap_footer', '手机底部文字', '', '版权所有 © 2005-2015 ECISP.CN&lt;br/&gt;\n 保留所有权利', 'text', '', 7, 0, ''),
...
(205, 4, 'isorder', '订单功能状态', '如果选择关闭订单功能，则与订单相关的所有功能无法使用', '1', 'bool', '启用订单功能,关闭订单功能', 3, 0, ''),
(206, 1, 'isenquiry', '询盘功能状态', '如果选择关闭询盘功能，则与询盘相关的所有功能无法使用', '1', 'bool', '启用询盘功能,关闭询盘功能', 3, 0, '');
