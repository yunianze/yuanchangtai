        ...
        <!-- 左侧结束 -->
            <div class="right-content">
                ...
                <ul  class="download-list clearfix">
                    ...
                    <li>
                        <a title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" href="<?php echo $this->_tpl_vars['rootdir'] ?><?php echo $this->htmlcode($this->_tpl_vars['array'][$i]['download'],1) ?>" download="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>">
