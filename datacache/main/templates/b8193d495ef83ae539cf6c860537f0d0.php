...
<body>
    ...
    <div class="bst_page ">
        ...
        <form name="infosearch" method="post" action="<?php echo $this->_tpl_vars['link'] ?>">
            ...
            <div class="bst_member_login_center bst_formwidth_c">
                <div class="title mb20">
                    ...
                    <div class="messtitle">Search</div>
                </div>
                <div class="bst_form_group">
                    <label for="title" class="control_label16">Keywords</label>
                ...
                <div class="bst_form_group">
                    <label for="title" class="control_label16">Types</label>
                    <div class="control_required20">
                        <select size="1" name="keyname" class="infoInput">
                            <option value="title" <?php if($this->_tpl_vars['keyname']=='title' ){ ?> selected<?php } ?>>Search by content title</option>
                            <option value="summary" <?php if($this->_tpl_vars['keyname']=='summary' ){ ?> selected<?php } ?>>Search by profile</option>
                            <option value="tsn" <?php if($this->_tpl_vars['keyname']=='tsn' ){ ?> selected<?php } ?>>Search by number</option>
                        </select>
                    </div>
                </div>
                <?php if(count($this->_tpl_vars['array'])>0){ ?>
                <div class="bst_form_group">
                    <label for="title" class="control_label16">category</label>
                    <div class="control_required20">
        ...
        <div class="bst_page_typename_width">Content search results<?php if($this->_tpl_vars['keyword']){ ?>：<?php echo $this->_tpl_vars['keyword'] ?><?php } ?></div>
        ...
        <?php }else{ ?>
        <div class="bst_page_botton">
            <div id="pagination">No related content found</div>
        </div>
        <?php } ?>
    </div>
</body>
