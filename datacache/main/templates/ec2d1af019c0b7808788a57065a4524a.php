    ...
    <div class="brand min-height">
        <div class="middle clearfix">
            ...
            <div class="rightCon">
                ...
                <ul class="brand_list mt110 clearfix" id="date">
                    ...
                    <li>
                        <a title="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>" href="<?php echo $this->_tpl_vars['array'][$i]['pic'] ?>" rel="lytebox[plants]">
                           <div> <img src="<?php echo $this->zoom($this->_tpl_vars['array'][$i]['pic'],251,333,'#fff',1) ?>" alt="">
                           <p><i><?php echo $this->_tpl_vars['array'][$i]['title'] ?></i></p>
                    </div>
                        </a>
                    </li>
                    <?php if($divid_i==6){ ?></div>
