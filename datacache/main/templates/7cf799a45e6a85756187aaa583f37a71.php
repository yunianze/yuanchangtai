...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['rootpath'] ?>css/Einside.css">
...
<body>
    ...
    <div class="middle clearfix">
        ...
        <div class="base_read commonRight map_read">
            ...
            <ul class="getLink">
                <li><span>Address</span><p><?php echo $this->_tpl_vars['read']['title'] ?></p></li>
                <li><span>Tel</span><p><?php echo $this->_tpl_vars['read']['content'] ?></p></li>
                <li class="clearMR"><span>E-mail</span><p><?php echo $this->_tpl_vars['read']['longtitle'] ?></p></li>
            </ul>
            <div id="add" style="display:none;">
            <?php echo $this->htmlcode($this->_tpl_vars['read']['mapcontent'],1) ?>
            </div>
            6623ef97c6f6ccf2fb032e800d2edda9form|fgid:2||||6623ef97c6f6ccf2fb032e800d2edda9
