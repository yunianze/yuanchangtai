        ...
        <div id="wrap">
            ...
            <div class="content article_list">
                ...
                <ul id="articlelist">
                    ...
                    <li id="download">
                        <a href="<?php echo $this->_tpl_vars['rootdir'] ?><?php echo $this->_tpl_vars['array'][$i]['download'] ?>" download="<?php echo $this->_tpl_vars['array'][$i]['title'] ?>">
                ...
                <a class="more r" href="javascript:pageajaxlist();">查看更多</a> <?php } ?> <?php }else{ ?>
