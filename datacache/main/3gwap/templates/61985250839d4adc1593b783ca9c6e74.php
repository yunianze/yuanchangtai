<div id="nav">
    ...
    <form class="search" name="infosearch" method="post" action="<?php echo $this->_tpl_vars['link'] ?>">
        ...
        <input type="text" id="keyword" name="keyword" placeholder="Enter the keywords" onfocus="searchOnFocus(this)" onblur="searchOnBlur(this)">
        <input type="submit" name="botton" value="">
    </form>
    214adb21252b0af7b03s214s9
    <!-- search end -->
    <a href="<?php echo $this->_tpl_vars['homelink'] ?>" class="home">Home</a>
    <ul id="mainNav">
