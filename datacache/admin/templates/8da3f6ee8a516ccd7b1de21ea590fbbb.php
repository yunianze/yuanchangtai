...
<script type="text/javascript">
	...
	var albummain_js_add_ok = "<?php echo $this->_tpl_vars['ST']['albummain_js_add_ok'] ?>";
	var albummain_js_add_no = "<?php echo $this->_tpl_vars['ST']['albummain_js_add_no'] ?>";
	...
	function saveResponse(options){
		...
		if (options=='true'){
			...
			alert(albummain_js_add_ok);
		}else{
			alert(albummain_js_add_no+" "+options);
		}
		parent.onaletdoc()
	}
</script>
...
<div id="mainbodybottonauto" class="managebottonadd">
	<div class="maindobycontent">
		<div class="suggestion">
			<span class="sugicon"><span class="strong colorgorning2"><?php echo $this->_tpl_vars['ST']['position_title'] ?></span><span class="colorgorningage"><?php echo $this->_tpl_vars['ST']['albummain_file_add_mess'] ?></span></span>
		</div>
				...
				<table class="formtable">
					<tr class="trstyle2">
						...
						<td class="trtitle02 colorgblue strong">
							<input type="text" name="title" size="50" maxlength="80" class="infoInput"/>
