<ul class="topnav" id="clickmenubotton">
	...
	<li>
		<span<?php if($this->_tpl_vars['menulinkarray'][$i]['mlid']==$this->_tpl_vars['menuid']){ ?> class="bgmenuhove"<?php } ?>><?php echo $this->_tpl_vars['menulinkarray'][$i]['menuname'] ?></span>
		<ul class="subnav">
