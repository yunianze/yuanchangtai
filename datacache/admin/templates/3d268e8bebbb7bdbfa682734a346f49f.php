			...
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="text" name="tags" id="tags" value="<?php echo $this->_tpl_vars['read']['tags'] ?>" class="infoInput" style="width:98%;"/>
						</td>
					</tr>
					<tr class="trstyle2">
						<td class="trtitle01"></td>
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02"><input type="text" name="headtitle" id="headtitle" value="<?php echo $this->_tpl_vars['read']['headtitle'] ?>" maxlength="100" class="infoInput" style="width:98%;"/></td>
					</tr>
					<tr class="trstyle2">
						<td class="trtitle01"></td>
						<td class="trtitle02">
				...
				<?php } ?>
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="text" name="filename" size="40" value="<?php if($this->_tpl_vars['type']=='edit'){ ?><?php echo $this->_tpl_vars['read']['filename'] ?><?php } ?>" maxlength="50" class="infoInput"/>
...
<input type="hidden" name="isbase" id="isbase" value="<?php echo $this->_tpl_vars['read']['isbase'] ?>">
<?php } ?>
</form>
</body>
</html>