...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#imgbgcolor').EasySiteColorSelect();
		$('#wmtcolor').EasySiteColorSelect();
		$('#inputcolor').EasySiteColorSelect();
		$('#sebgcolor').EasySiteColorSelect();
		$('#scfcolor').EasySiteColorSelect();
	})
	...
	<div class="maindobycontent">
		...
		<div class="lefteditor">
			<ul>
				...
				<li <?php if($this->_tpl_vars['groupid']==$this->_tpl_vars['array'][$i]['key'] ){ ?>class="hover" <?php } ?>id="tabbottonul<?php echo $this->_tpl_vars['array'][$i]['key'] ?>"  onmousedown="javascript:windowsclass('#tabbottonul<?php echo $this->_tpl_vars['array'][$i]['key'] ?>','#tabcontentdiv<?php echo $this->_tpl_vars['array'][$i]['key'] ?>','tabbottonul','tabcontentdiv',<?php echo $this->_tpl_vars['array'][$i]['key'] ?>,10,'hover','');"><?php echo $this->_tpl_vars['array'][$i]['name'] ?></li>
				<?php }} ?>
			</ul>
		</div>
			...
			<table class="formtable <?php if($this->_tpl_vars['array'][$i]['key']!=$this->_tpl_vars['groupid']){ ?>displaynone<?php } ?>" id="tabcontentdiv<?php echo $this->_tpl_vars['array'][$i]['key'] ?>">
				...
				<tr class="trstyle2">
					...
					<td class="trtitle02">
						...
						<input type="text" name="<?php echo $this->_tpl_vars['array'][$i]['list'][$ii]['valname'] ?>" size="30" maxlength="250" value="<?php echo $this->_tpl_vars['array'][$i]['list'][$ii]['value'] ?>"<?php if($this->_tpl_vars['array'][$i]['list'][$ii]['isselect']){ ?> id="<?php echo $this->_tpl_vars['array'][$i]['list'][$ii]['isselect'] ?>" <?php } ?>class="infoInput"/>
						<?php } ?>
...
<div id="downbotton">
	<div id="subbotton">
		<table border="0" width="100%">
			<tr>
				<td id="center"><input type="submit" name="Submit" value="<?php echo $this->_tpl_vars['ST']['botton_edit'] ?>" class="button orange" /></td>
			</tr>
		</table>
	</div>
</div>
