...
<script type="text/javascript">
	...
	var modelmanage_js_attr_add_ok = "<?php echo $this->_tpl_vars['ST']['modelmanage_js_attr_add_ok'] ?>";
	var modelmanage_js_attr_add_no = "<?php echo $this->_tpl_vars['ST']['modelmanage_js_attr_add_no'] ?>";
	...
	function formverify(formData, jqForm, options) {
		...
		if(get['typename']==""){
			document.modelattradd.typename.focus();
	...
	function saveResponse(options){
		...
		if (options=='true'){
			...
			alert(modelmanage_js_attr_add_ok);
		}else{
			alert(modelmanage_js_attr_add_no+options);
		}
...
<body>
<form name="modelattradd" id="modelattradd" method="post" action="index.php?archive=modelmanage&action=modelattrsave">
<div id="mainbodybottonauto" class="managebottonadd">
	<div class="maindobycontent">
		<!--查看已选择的类型-->
		<div class="suggestion">
			<span class="sugicon"><span class="strong colorgorning2"><?php echo $this->_tpl_vars['ST']['position_title'] ?></span><span class="colorgorningage"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_add_mess'] ?></span></span>
		</div>
			...
			<div class="maneditcontent">
				<table class="formtable">
					<tr class="trstyle3">
						...
						<td width="85%" class="trtitle02"><input type="text" name="typename" size="80" maxlength="50"  class="infoInput"/></td>
					</tr>
					<tr class="trstyle2">
					...
					<tr class="trstyle2">
						<td width="15%" class="trtitle011"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_add_attrname'] ?></td>
						<td width="85%" class="trtitle02">
							<input type="text" name="attrname" size="25" maxlength="50"  class="infoInput"  onblur="checktypename('attrname',this.value,'index.php?archive=modelmanage&action=checkattrname&mid=<?php echo $this->_tpl_vars['mid'] ?>&inputtype='+document.modelattradd.inputtype.value,'attrnameerr','<?php echo $this->_tpl_vars['ST']['modelmanage_js_attr_input_ok'] ?>','<?php echo $this->_tpl_vars['ST']['modelmanage_js_attr_input_no'] ?>','attrsubmitbotton');"/>
					...
					<tr class="trstyle3">
						...
						<td width="85%" class="trtitle02"><input type="text" name="typeremark" size="80" maxlength="200"  class="infoInput"/> </td>
					</tr>
					<tr class="trstyle2">
						<td width="15%" class="trtitle01"></td>
					...
					<tr class="trstyle3 displaynone" id="validatetextdiv">
						<td width="15%" class="trtitle01"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_add_validatetext'] ?></td>
						<td width="85%" class="trtitle02">
					...
					<tr class="trstyle2">
						...
						<td width="85%" class="trtitle02"><input type="text" name="attrsize" size="6" maxlength="3" value="20" class="infoInput"/> <span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_add_attrsize_mess'] ?></span></td>
					</tr>
					<tr class="trstyle2">
						<td width="15%" class="trtitle01"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_add_attrrow'] ?></td>
						<td width="85%" class="trtitle02"><input type="text" name="attrrow" size="6" maxlength="3" value="5" class="infoInput"/> <span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_add_attrrow_mess'] ?></span></td>
					</tr>
					<tr class="trstyle2">
						<td width="15%" class="trtitle01"><?php echo $this->_tpl_vars['ST']['modelmanage_attr_issearch_validatetext'] ?></td>
						<td width="85%" class="trtitle02">
							<input type="radio" value="1" name="issearch"/> <?php echo $this->_tpl_vars['ST']['open_botton_title'] ?>&nbsp;
							<input type="radio" value="0" name="issearch" checked="checked"/> <?php echo $this->_tpl_vars['ST']['close_botton_title'] ?>
