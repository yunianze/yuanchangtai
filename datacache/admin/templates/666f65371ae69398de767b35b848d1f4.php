...
<script type="text/javascript">
	...
	function bat_formverify(formData, jqForm, options) {
		...
		var loadurl='index.php?archive=createmain&action=createbatwindow&lng='+get['lng']+'&isbatdoc='+get['isbatdoc']+'&creattype='+get['creattype']+'&time='+get['time'];
		...
		<div class="manageeditdiv">
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2">
						<td class="trtitle01"><?php echo $this->_tpl_vars['ST']['createmain_bat_add_isdoc'] ?></td>
						<td class="trtitle02">
							<input type="radio" value="1" name="isbatdoc"/> <?php echo $this->_tpl_vars['ST']['createmain_bat_add_isdoc1'] ?>&nbsp;
							<input type="radio" value="0" name="isbatdoc" checked="checked"/> <?php echo $this->_tpl_vars['ST']['createmain_bat_add_isdoc2'] ?>&nbsp;
						</td>
					</tr>
					<tr class="trstyle2">
						<td class="trtitle01"></td>
						<td class="trtitle02 colorghow lineheight160"><?php echo $this->_tpl_vars['ST']['createmain_bat_add_type_mess'] ?></td>
					</tr>
				</table>
			</div>
		</div>
