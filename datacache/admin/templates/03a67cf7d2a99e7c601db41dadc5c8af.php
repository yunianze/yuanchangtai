...
<script type="text/javascript">
	...
	var sqllist_js_import_ok = "<?php echo $this->_tpl_vars['ST']['sqllist_js_import_ok'] ?>";
	var sqllist_js_import_no = "<?php echo $this->_tpl_vars['ST']['sqllist_js_import_no'] ?>";
	...
	<div id="mainbodyauto" class="manageedit">
		<div class="maindobycontent">
			...
			<div class="suggestion">
				<span class="sugicon"><span class="strong colorgorning2"><?php echo $this->_tpl_vars['ST']['position_title'] ?></span><span class="colorgorningage"><?php echo $this->_tpl_vars['ST']['sqllist_import_mess'] ?></span></span>
			</div>
	...
	<div id="downbotton">
		<div id="subbotton">
			<table border="0" width="100%">
				<?php if(count($this->_tpl_vars['array']) > 0){ ?>
				<tr>
					<td id="right"><input type="submit" name="Submit" value="<?php echo $this->_tpl_vars['ST']['botton_import'] ?>" class="button orange" /></td>
					<td id="left" class="padding-left5"><input type="button" name="cancel" onClick="javascript:parent.onaletdoc();" value="<?php echo $this->_tpl_vars['ST']['botton_import_reset'] ?>" class="button orange" /></td>
				</tr>
				<?php }else{ ?>
				<tr>
					<td id="center"><input type="button" name="cancel" onClick="javascript:parent.onaletdoc();" value="<?php echo $this->_tpl_vars['ST']['botton_import_reset'] ?>" class="button orange" /></td>
				</tr>
				<?php } ?>
			</table>
		</div>
